...
<li><strong>Region.</strong> The country breakdown tells you whether your readers are where you think they are. I write in British English and check UK interest specifically; a topic that is large in the US and flat in the UK is a different piece.</li>
...
<p>The second use is finding articles you have not written. Queries that bring impressions to a page that only half-answers them are a content list, ranked by demand, sitting in your own account. When I looked at mine, <a href="/articles/ai-meeting-notetakers-compared">the meeting notetaker comparison</a> was picking up consent-law queries it only touched on, which is how the consent section in that piece got longer.</p>
...
<p>Ahrefs gives away a version of its Site Explorer and Site Audit for any site you can verify ownership of. As of my check that means keyword and backlink data for your own pages, a technical crawl that flags broken links, missing metadata and slow pages, and a privacy-first analytics option, with limits that a small site will not hit — 5,000 crawl credits a month and a thousand rows at a time in the explorer.</p>
...
<p>Still, for a site under a few hundred pages, the Site Audit alone is worth the sign-up. It found redirect chains on ToolNest that I had not noticed, and it will find the same on yours.</p>
...
<p>The free allowance is a few searches a day, and the Starter plan is around $20 a month at the time of writing. It is worth that if you write FAQ sections and want the questions people actually type rather than the ones you imagine. It is not worth it as a demand tool, because auto-complete tells you a phrase exists, not how often anyone searches it. Every FAQ block on this site started as one of these lists, then had the questions I could not honestly answer removed.</p>
...
<p>Pay when you spend more time working around the free limits than the subscription costs in hours, or when you genuinely need to see a competitor's data. That is typically an agency, a large content team or a site whose revenue depends on ranking for a few specific terms. If you are a small publication deciding what to write this week, the tools above answer the question, and the £100 a month is better spent on the writing. I went through the same calculation for my own stack in <a href="/articles/auditing-small-team-software-spend">what I pay for and what I cancelled</a>, and the SEO suite is on the cancelled side.</p>`,
};
